...
No SaaS middleman sees your ticket data: raw ticket/issue content is
fetched directly from your Jira/Asana/GitHub account, stripped of PII
(names, emails, IPs) inside your own containers, and only the
sanitized text is sent to the LLM provider you configure. Everything
...
provider you pick (and only after PII stripping).
